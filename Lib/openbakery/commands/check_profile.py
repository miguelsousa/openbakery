...
from openbakery.errors import ValueValidationError
from openbakery.multiproc import multiprocessing_runner
from openbakery.reporters.terminal import TerminalReporter
from openbakery.reporters.serialize import SerializeReporter
from openbakery.reporters.badge import BadgeReporter
from openbakery.reporters.ghmarkdown import GHMarkdownReporter
    ...
    if profile_arg:
        argument_parser.add_argument('profile',
                                     help='File/Module name,'
                                          ' must define a openbakery "profile".')
