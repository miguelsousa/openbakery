...
def canonical_stylename(font):
    ...
    from openbakery.utils import suffix
    from openbakery.constants import STATIC_STYLE_NAMES, VARFONT_SUFFIXES
...
def readme_directory(readme_md):
    ...
    if isinstance(readme_md, list):
        ...
        # This here is just a quirk of the way we handle openbakery inputs nowadays.
...
def license_path(licenses):
    ...
    # FIXME: We should have a openbakery check for that, though!
...
def hinting_stats(font):
    ...
    from openbakery.profiles.shared_conditions import is_ttf, is_cff, is_cff2
...
def remote_styles(familyname_with_spaces, config):
    ...
    def download_family_from_Google_Fonts(familyname):
        ...
        from openbakery.utils import download_file
...
def gfonts_repo_structure(fonts):
    ...
    from openbakery.utils import get_absolute_path
