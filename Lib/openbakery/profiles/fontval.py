...
try:
    ...
    sys.exit(
        ...
        "\n"
        "python -m pip install -U 'openbakery[fontval]'\n\n"
    )
...
def com_google_fonts_check_fontvalidator(font, config):
    ...
    disabled_fval_checks = [
        ...
        # OpenBakery has got a native check for the xAvgCharWidth field
        ...
        # OpenBakery has its own check for required/optional tables:
        ...
        # OpenBakery has its own check for this.
