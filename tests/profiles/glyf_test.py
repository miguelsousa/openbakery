...
def test_check_glyf_unused_data():
    ...
    check = CheckTester(opentype_profile, "com.google.fonts/check/glyf_unused_data")
...
def test_check_points_out_of_bounds():
    ...
    check = CheckTester(opentype_profile, "com.google.fonts/check/points_out_of_bounds")
